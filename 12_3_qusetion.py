...
# if score1 >= 50 and score2 >= 70 and avg >= 70:
#     print('합격')
# else:
#     print('불합격')
...
#         lotto.append(num)
#     if len(lotto) == 6:  # len(리스 또는 문자열) --> 총 개수(총 글자수)
#         break
...
# word = ['사자', '고양이', '호랑이', '기린', '토끼', '다람쥐', '늑대', '펭귄', '코끼리', '개']
# input('타자게임 시작(엔터 입력)')

# w = random.choice(word)
# n = 1 # 문제번호
# while True:
#     my = input(f'문제{n} (종료0): {w}')
#     my = input()
#     if my == '0': # 0을 입력하면 종료!
#         break
#     elif my == w:
