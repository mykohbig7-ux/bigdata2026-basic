...
# fubao = Animai()        #인스턴스(객체) 생성
# fubao.get_height()# 인스턴스 메서드 호출

# class Dog(Animai): # 자식(서브) 클래스 정의 class 자식클래스명(부모클래스명):
#     pass

# class Cat(Animai): # 자식(서브) 클래스 정의
#     pass
...
# print(person1) # <__main__.Parent object at 0x000001FF668290D0>
# print(person2) # <__main__.Child object at 0x000001FF66829AD0>
...
class Hybird(Car):
    ...
    def hybird_info(self): # 인스턴스 메서드 정의
