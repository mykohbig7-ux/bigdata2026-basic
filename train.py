...
import json 
import joblib  # 학습이 끝난 파이프라인(전처리+모델) 파일을 저장하고 나중에 다시 불러오기 위해 사용
import pandas as pd
...
def build_pipeline() -> Pipeline:
    ...
    # --- 컬럼별로 다른 전처리를 동시에 적용 ---
    # ColumnTransformer : "이 열은 numeric_pip로, 저 열은 category_pipe로 한 번에 지정해서 병렬 처리"
...
if __name__ == '__main__':
    # 이 파일을 직접 python train.py 형태로 실행했을 때만 동작
